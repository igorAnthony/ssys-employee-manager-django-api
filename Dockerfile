# Use Python 3.12.7 image based on Debian Bullseye in its slim variant as the base image
...
# Install the PostgreSQL development libraries and build tools (gcc, make, etc.)
